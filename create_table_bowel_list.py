...
def create_table(table_name, column_names):
    ...
    columns_with_types = ', '.join([f"{column} VARCHAR(50) NOT NULL" for column in column_names])
    create_table_sql = f"""
...
if __name__ == "__main__":
    ...
    table_name = 'bowel_chart'
    csv_file = 'C:/Users/Peter/Blueprint/csv/bowel_chart.csv'
